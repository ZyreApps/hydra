...
(def state-events {
  ...
  :connected {
    HydraMsg/GET_TAGS [ (action get-all-tags) (send HydraMsg/GET_TAGS_OK) ]
    HydraMsg/GET_TAG [ (action get-single-tag .tag) (send HydraMsg/GET_TAG_OK) ]
    HydraMsg/GET_POST [ (action get-single-post .post_id) (send HydraMsg/GET_POST_OK) ]
    HydraMsg/GOODBYE [ (send HydraMsg/GOODBYE_OK) terminate ]
    :* [ (send HydraMsg/INVALID) terminate ]
  }
  :external {
    :* [ (send HydraMsg/INVALID) terminate ]
